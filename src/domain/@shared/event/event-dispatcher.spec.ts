...
import SendEmailWhenProductIsCreatedHandler from "../../product/event/handler/send-email-when-product-is-created.handler";//../product/handler/send-email-when-product-is-created.handler
import EnviaConsoleLog1Handler from "../../customer/event/handler/send-console-log-1.handler";//../event/customer/handler/send-console-log-1.handler
import EnviaConsoleLog2Handler from "../../customer/event/handler/send-console-log-2.handler";//../event/customer/handler/send-console-log-2.handler
import EnviaConsoleLogHandler from "../../customer/event/handler/send-console-log.handler";//../event/customer/handler/send-console-log.handler
import ProductCreatedEvent from "../../product/event/product-created.event";//../product/product-created.event
import CustomerCreatedEvent from "../../customer/event/customer-created.event";//../event/customer/customer-created.event
import EventDispatcher from "./event-dispatcher";//./event-dispatcher
import CustomerAddressUpdatedEvent from "../../customer/event/customer-address-updated.event"; //../event/customer/customer-address-updated.event
